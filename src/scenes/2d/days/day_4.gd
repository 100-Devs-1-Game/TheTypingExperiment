...
func _ready() -> void:
	...
	corruption_animation_manager.name = "Day4CorruptionAnimationManager"
	corruption_animation_manager.set_day(4)
	add_child(corruption_animation_manager)

	# Setup horror effects manager for Day 4
...
func _show_message(message: String) -> void:
	...
	# Day 4 - Use standardized horror effects
	if horror_effects:
		await horror_effects.show_day4_style_message(message_overlay, message)
	else:
...
func _setup_horror_effects() -> void:
	...
	horror_effects.name = "Day4HorrorEffects"
